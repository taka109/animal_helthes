...
<body>
    ...
    <form action ="editcomp" method = "POST">
        ...
        <div class ="data">
                <h3>動物の種類</h3>
                <select name = "animals_id" value = "{{$pets->animals_id}}">
        ...
        <div class ="data">
            <h3>生年月日</h3>
            <input type ="date" name = "date" class ="date" value ="{{$pets->birth}}">
            @if($errors->has('date'))
            <li>生年月日は必須です</li>
            @endif
        </div>
        <div class ="data">
            <h3>体重</h3>
            <input type ="number" name ="weight" class ="weight" value ="{{$pets->weight}}">g
